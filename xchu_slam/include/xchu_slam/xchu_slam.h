...
#ifndef __XCHU_SLAM__
#define __XCHU_SLAM__
...
private:
    ...
    ros::Publisher pub_current_odom_;
    ros::Publisher pub_recent_keyframes_;
    ros::Publisher pub_current_points_;
    ...
    pcl::VoxelGrid<pcl::PointXYZI> downSizeFilterSource;
    ...
    pcl::VoxelGrid<pcl::PointXYZI> downSizeFilterSurroundingKeyPoses; // for surrounding key poses of scan-to-map optimization
